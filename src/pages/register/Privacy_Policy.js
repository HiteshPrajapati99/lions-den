  ...
  return (
    <Box sx={{ p: { xs: "4rem 2rem", md: 8 } }}>
      <Box py={5}>
        ...
        >
          PRIVACY <span style={{ color: "#fff" }}>POLICY</span>
        </Typography>
        ...
        >
          ...
          of our Service. Affiliate means an entity that controls, is controlled
          ...
          "We", "Us" or "Our" in this Agreement) refers to Aadvik Management
          LLP, Morbi, Gujarat, India. Cookies are small files that are placed on
          ...
          its many uses. Country refers to: Gujarat, India Device means any
          ...
          Website refers to The Lions' Den, accessible from
          https://thelionsden.co.in/ You means the individual accessing or using
          ...
          <br />
          https://thelionsden.co.in/contact%20us/contact-us.html
        </Typography>
      </Box>
    </Box>
  );
